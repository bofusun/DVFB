...
class MT10_V2(Benchmark):

    ENV_NAMES = _ml1_env_names()

    def __init__(self, env_name):
        super().__init__()
        cls = _env_dict.MT10_V2[env_name]
        args_kwargs = _env_dict.MT10_V2_ARGS_KWARGS[env_name]
...
class MT50_V2(Benchmark):
    ...
    def __init__(self, env_name):
        super().__init__()
        try:
            cls = _env_dict.MT50_V2['train'][env_name]
            args_kwargs = _env_dict.MT50_V2_ARGS_KWARGS['train'][env_name]
        except KeyError:
            cls = _env_dict.MT50_V2['test'][env_name]
            args_kwargs = _env_dict.MT50_V2_ARGS_KWARGS['test'][env_name]
        self._train_classes = OrderedDict([(env_name, cls)])
        self._test_classes = self._train_classes
        self._train_ = OrderedDict([(env_name, cls)])
        self._train_tasks = _make_tasks(self._train_classes,
...
class ALL_V2(Benchmark):
    ...
    def __init__(self, env_name):
        super().__init__()
        cls = _env_dict.ALL_V2_ENVIRONMENTS[env_name]
        args_kwargs = _env_dict.ALL_V2_ARGS_KWARGS[env_name]
        self._train_classes = OrderedDict([(env_name, cls)])
        self._test_classes = self._train_classes
        self._train_ = OrderedDict([(env_name, cls)])
        self._train_tasks = _make_tasks(self._train_classes,
...
__all__ = ["ML1", "MT1", "ML10", "MT10", "ML45", "MT50", "MT10_V2", "MT50_V2", "ALL_V2"]
